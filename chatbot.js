...
const getChatbotScript = () => {
    chatbotScript = {
        ...
        "questions": [
            ...
            {
                "question_no": "2",
                "question_text": "We have 3 location available- <ol><li>Pune</li><li>Mumbai</li><li>Bangalore</li></ol>",
            ...
            {
                "question_no": "3",
                "question_text": "You can contact our agent at: +91 8055508899, Also you can submit a query <a href='https://propmajestic.com/contact.php' target='_blank'>here</a>",
            ...
            },
            {
                ...
                "optional_text": "You can contact our agent at: +91 8055508899, Also you can submit a query <a href='https://propmajestic.com/contact.php' target='_blank'>here</a>",
                "answers": [
...
const printBotMessage = (queText) => {
    $(".typing").hide();
    conversationContainer.innerHTML +=
      '<div class="msg cbt"> <img src="/icon_cbt.png" width="36" height="36"> <div class="content">' +
      queText +
      "</div></div>";
    $("html, body").animate(
      {
  ...
  const printUserMessage = (ansText) => {
    conversationContainer.innerHTML +=
      ...
      ansText +
      '</xmp></div><img src="/icon_usr.png" width="36" height="36"> </div>';
    setTimeout(() => {
      $("html, body").animate(
        {
          scrollTop:
...
const showTypingIndicator = () => {
    conversationContainer.innerHTML +=
      '<div class="msg cbt typing"> <img src="https://propmajestic.com/img_new/logo.png" width="36" height="36"> <div class="content" style="display: flex;">' +
