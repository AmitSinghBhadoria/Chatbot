...
function loadBasicImports() {
    ...
    chatbotCdnCss.href = urlConstant + "/index.css";
...
function loadChatbot() {
    ...
    input.type = "image";
    input.src = "https://propmajestic.com/img_new/logo.png";
    ...
    iframe.src = urlConstant + "/chatbot.html";
    iframe.id = "chatbotIframe";
    iframe.className = "iframeDiv";
    iframe.className += " position_right ";
    iframe.className += " small_iframe ";
  ...
  function openChatbot() {
    ...
    if (x.style.display === "none") {
      ...
      image.src = urlConstant + "/close.png";
      image.style.padding = "3px";
    } else {
      x.style.display = "none";
      image.src = "https://propmajestic.com/img_new/logo.png";
